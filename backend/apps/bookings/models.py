...
from apps.flights.models import Flight, FlightInstance, Seat
...
class Passenger(models.Model):
    ...
    seat = models.ForeignKey(Seat, on_delete=models.SET_NULL, null=True, blank=True, related_name='passengers')
