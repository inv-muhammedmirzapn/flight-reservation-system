...
export default function ChangePasswordModal({ isOpen, onClose }) {
  ...
  const errors = useMemo(() => {
    const e = {};
    if (!pwdData.oldPassword && touched.oldPassword)
    ...
    if (touched.newPassword) {
      ...
      else if (pwdData.oldPassword && pwdData.newPassword === pwdData.oldPassword)
  ...
  const renderRequirements = () => {
    ...
    const checks = [
      ...
      { label: "Different from current password",     ok: !!pwdData.oldPassword && pwdData.newPassword !== pwdData.oldPassword },
    ];
    return (
